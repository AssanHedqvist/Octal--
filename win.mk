...
game: main.o vec2.o physicsObject.o renderObject.o keyboard.o player.o spriteHandler.o text.o attacks.o sounds.o
	gcc -o game.exe main.o vec2.o physicsObject.o renderObject.o keyboard.o player.o spriteHandler.o text.o attacks.o sounds.o -L$(LIBS) $(LDFLAGS)
main.o: 
